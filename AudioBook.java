...
public class AudioBook extends AudioContent
{
  ...
  // Print information about the audiobook. First print the basic information of the AudioContent 
	...
	public void printInfo()
	{
		...
		System.out.print("Author: " + author + " Narrated by: " + narrator + "\n"); //prints the remaining required audiobook information
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play()
	{
		setAudioFile(chapterTitles.get(currentChapter) + ".\n" + chapters.get(currentChapter)); //sets the audiofile in the superclass to the desired chapter of the audiobook
	...
	{
		int index = 0;
		//forloop runs through the arraylist of chaptertitles and prints the titles with the associated index
	...
	{
		AudioBook otherAudioBook  = (AudioBook) other; //casts the other object to be an audiobook object
		//compares the audiocontent information from using the superclass method, as well as the author and narrator to see if they are equal; returns true or false
		return super.equals(otherAudioBook) && this.author.equals(otherAudioBook.author) && this.narrator.equals(otherAudioBook.narrator); 
	}
